  ...
  return (
    <main>
      ...
      <section className="py-5.5 px-5 my-1 bg-gray-200 lg:mx-5 mx-3  rounded-lg flex lg:flex-row flex-col justify-around gap-3.5 items-center">
        <article className="">
          <H2_Element
            text="If you don't love it, list it"
        ...
        <article className="flex gap-1 lg:w-1/2">
          ...
          <div className="w-1/2 h-60 bg-gray-700 grid place-content-center">
            <img src={nike1} alt="image" loading="lazy" />
          </div>
        </article>
      </section>
      ...
      <section className="lg:px-5 px-3">
        ...
        <SellingFAQ
          ...
          id={1}
          text={
            "Once your item sells we generally charge 10-15% of the final value. Your first 250 listings each month are fre and after there's a $0.35 insertion fee per listing."
          }
        ...
        <SellingFAQ
          ...
          text={
            "Swap and Shop provides recommendations, but you can choose a preffered shipping carrier. Can't make it to your local dropoff? Some offer free \"ship from home\" pickup. Print your shipping labels with Swap and Shop to receive a discount from the carriers we work with. If you don't have a printer, we also offer QR codes for Swap and Shop labels."
          }
          handleSpanClick={() => navigate("/")}
        />
        ...
        <SellingFAQ
          ...
          text={
            "You can use any packing supplies you may already have at home or get free boxes from carriers. For an added touch, Swap and Shop branded supplies are available to purchase."
          }
        ...
        <SellingFAQ
          ...
          text={
            "To get started, select List an item. We'll help you create and verify your account and set-up payment informationg during your first listing. Have your preferred payment account details on hand and be ready to receive a call or text on your phone for verification."
          }
          handleSpanClick={() => navigate("/")}
        />
